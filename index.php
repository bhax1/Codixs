    ...
    <header class="pt-5" style="--bs-body-bg: var(--bs-body-bg);">
        <div class="container pt-4 pt-xl-5">
            <div class="row pt-5">
                ...
                <div class="col"><img class="img-fluid" src="assets/img/illustrations/meeting.svg" style="width: 800px;" width="309" height="233"></div>
                ...
                <div class="col-md-8 mx-auto">
                    <div class="accordion text-muted" role="tablist" id="accordion-1">
                        <div class="accordion-item">
                            <h2 class="accordion-header" role="tab"><button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#accordion-1 .item-1" aria-expanded="true" aria-controls="accordion-1 .item-1">Is it easy?</button></h2>
                            <div class="accordion-collapse collapse show item-1" role="tabpanel" data-bs-parent="#accordion-1">
                                <div class="accordion-body">
                                    <p>It depends</p>
                                    <p class="mb-0">No and Yes</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header" role="tab"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#accordion-1 .item-2" aria-expanded="false" aria-controls="accordion-1 .item-2">Is it paid?</button></h2>
